...
- **src/adminAuth.js** - Admin authentication with bcrypt password hashing, session management (24h expiry), login attempt tracking (5 attempts, 15-min lockout)
...
- **public/admin.html** - Admin dashboard with room management and log audit tabs
- **public/js/admin.js** - AdminClient class handling authentication, room CRUD operations, and log viewing
